...
execute()
{
  xrun $xrun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../shake_sha2.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../shake_sha2.gen/sources_1/bd/system/ipshared/34f8/hdl" \
       +incdir+"../../../../shake_sha2.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../shake_sha2.gen/sources_1/bd/system/ipshared/34f8/hdl" \
       +incdir+"D:/Downloads/vivado_2020/Vivado/2020.2/data/xilinx_vip/include"
}
