...
HD_PWD='D:/Project/Vivado_prj/shake_sha2/ip/managed_ip_project/managed_ip_project.tmp/shake_sha2_ip_v1_0_project/shake_sha2_ip_v1_0_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log shake_sha2_ip_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source shake_sha2_ip_v1_0.tcl -notrace
