...
int final_hardware_test(u32 base_addr)
{
    ...
    const unsigned char golden_output[32] = {
        0xB7, 0x67, 0x66, 0x4F, 0x8D, 0x28, 0xA3, 0x13, 0x6C, 0x59, 0x4D, 0x3C,
        0x2B, 0xE8, 0x80, 0x4C, 0x42, 0x6E, 0x1E, 0x05, 0x96, 0x7A, 0x55, 0xF7,
        0x92, 0x37, 0x3B, 0xC2, 0xF5, 0x22, 0xF2, 0x49
    };
